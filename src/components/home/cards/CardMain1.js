...
<div class="pr-2 ml-1 mr-8 rounded-3xl">
    <div class="bg-[#F7EAA9] shadow-xl py-3 px-2 rounded-3xl">
        ...
        <div class="p-1">
            ...
            <div class="flex flex-row bg-[#C6B34E] py-2 px-1 rounded-2xl mt-4">
                <div class="flex text-white px-3 font-medium text-center"> 12 posts</div>
                <div class="flex text-white px-3 font-medium text-center">882 followers</div>
                <div class="flex text-white px-3 font-medium text-center">64 following</div>
                <div class="flex text-white px-3 font-medium text-center">918 likes</div>
            </div>

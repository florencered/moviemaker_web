...
function Connections() {
    ...
    return (
      <div className="ml-32  w-400 mt-30 text-left box-content w-fit bg-[#e0d59a]">
        <div className="mb-10">
          <button className="relative pr-14" onClick={toggleRestrictedAccounts}>
          ...
          {RestrictedAccountsVisible && (
            <div className="text-center mt-30 mb-10">
              <p className="w-[650px] mt-10">
                Restrict people from knowing you online / offline status <br />

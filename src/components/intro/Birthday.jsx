  ...
  return (
    <>
      ...
      <div className="form-control mt-6">
        <button className="btn bg-[#C6B34E] rounded-full border-none text-black hover:bg-[#978839] normal-case" onClick={() => { window.location.href = '/auth/phone' }}>Next</button>
        <p className="text-1xl font-semibold text-center text-[#978839]"><Link to="/auth/register">Go back</Link></p>

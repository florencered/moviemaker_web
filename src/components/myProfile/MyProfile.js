...
export const MyProfile = () => {
  return (
    ...
    <div className="l" class="bg-white flex flex-row justify-center w-full">
          ...
          <div className="overlap-group">
            <div className="group">
              ...
              <div className="overlap-2">
                ...
                <img className="vector" alt="Vector" src="assets/vector-10.png" />
              </div>
      ...
      <div className="group-wrapper">
        <div className="group">
          <img className="vector" alt="Vector" src="assets/vector.png" />
          <img className="img" alt="Vector" src="assets/vector2.png" />
          <img className="vector-2" alt="Vector" src="assets/vector3.jpg" />
          <img className="vector-3" alt="Vector" src="assets/vector4.png" />
          <img className="material-symbols" alt="Material symbols" src="assets/vector5.png" />
          <img className="material-symbols-2" alt="Material symbols" src="assets/vector6.png" />
          <img className="line" alt="Line" src="line82.png" />
        </div>
      </div>
    </div>

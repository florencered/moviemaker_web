...
function sidebar(props) {
  return (
    <>
        <div class = "flex flex-col bg-black h-10 w-64 mt-8 rounded-3xl ml-1 pt-1">
            {/* <div class ="flex-auto p-0 h-0"><img src={props.props1} className="App-logo h-12 w-12" alt="logo"/></div> */}
            <span class="text-center flex ml-12" style={{alignItems:"center",width: "150px",height:"200px"}}><img class="h-8 w-8 rounded-full" src="/images/flix_Logo.svg"/><h4 class="font-bold text-lg text-[#E0C949] flex-auto p-0 text-center">flixdin</h4></span>
            <span class =""></span>
        ...
        <a href="/"><div class = "flex flex-row rounded-lg ml-11 mr-5 mt-2 p-1 hover:bg-white font-semibold"><FaClapperboard size="1.5rem" class="ml-5 mt-1"></FaClapperboard>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Connection Calls</div></a>

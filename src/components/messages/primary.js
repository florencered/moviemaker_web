...
function Primary() {
    return (
        <div className="flex flex-row mt-3">
            ...
            <p className="font-semibold text-[19px] tracking-normal text-green-500">PRIMARY</p>
                ...
                <li class="flex flex-row">
                    ...
                    <div className="ml-5 mt-2">
                        <p className="font-bold text-[21px] tracking-normal text-green-600">Killan James</p>
                        <p className="font-semibold text-[12px] tracking-normal text-black">5 new messages</p>
                    </div>
                </li>
            </ul>
        </div>

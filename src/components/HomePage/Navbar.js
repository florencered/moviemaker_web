  ...
  return (
    <>
        <div class = "flex flex-col bg-black h-10 w-64 mt-8 rounded-3xl ml-2 pt-1">
            ...
            <span class="text-center flex" style={{alignItems:"center",width: "96px",height:"200px"}}><img class="h-8 w-8 rounded-full" src={props.props1}/></span>
            <div class ="flex-auto text-yellow-300 p-0 text-center"><h4 class="font-semibold text-lg">flixdin</h4></div>

  ...
  return (
    <>
      ...
      <div className="form-control mt-2">
        <button className="btn bg-[#C6B34E] rounded-full normal-case border-none text-black hover:bg-[#978839]"onClick={() => { window.location.href = '/auth/terms'}}>Add Skills</button>
